    ...
    <div className="min-h-screen grid w-full items-center bg-zinc-900 px-4 font-mono text-sm text-white">
      <SignUp.Root>
        ...
        >
          ...
          <SignUp.Strategy name="email_code">
            <Clerk.Field name="code" className="space-y-1">
              <Clerk.Label className="font-bold text-yellow-400 uppercase font-game">
                Email Code
              </Clerk.Label>
              <Clerk.Input
                type="otp"
                ...
                className="w-full px-3 py-2 bg-zinc-900 border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-yellow-400 text-white"
              />
              <Clerk.FieldError className="text-sm text-red-500 font-game" />
            </Clerk.Field>
            <SignUp.Action
              submit
              className="w-full px-4 py-2 bg-yellow-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase font-game"
            >
              Verify
            </SignUp.Action>
          </SignUp.Strategy>
          ...
          <p className="text-center text-xs text-yellow-400 font-game">
            ...
            <Clerk.Link
              navigate="sign-in"
              className="font-bold underline underline-offset-2 hover:text-yellow-200 font-game"
            >
              Sign in
            </Clerk.Link>
          </p>
        ...
        >
          ...
          <Clerk.GlobalError className="block text-sm text-red-500 font-game" />
